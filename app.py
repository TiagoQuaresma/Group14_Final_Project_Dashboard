...
#FIRST 2 PARTS (1 e 2)
    html.Div([
        html.Div([
            ...
            html.Div([              
                            html.P('Check out the differences between the renewable and non-renewable sources of the electricity we consume! Biofuels win the race in renewable sources and Nuclear energy dominates non-renewable.'),
        ...
        html.Div([
            ...
            dcc.Graph(id = 'cheese_graph', figure = fig_ce),html.Div([              
                            html.P('Here we have the energy sources of the electricity that each country uses. With this we can have a better understanding of whether the country is more dependent on renewable or non-renewable energies and what are the respective sources. Select different countries and explore the results!')
...
#EUROPE MAP
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                html.Label('3.Source of energy in each European Country'),
                html.Br(),
                html.Br(),
                ...
                html.Div([              
                            html.P('On the map above you can inspect the various sources of electricity used by each country and see the differences between them by source! Choose the different countries from the buttons above and check out the discrepancies!')
...
#PRICE OF ELECTRICITY
    html.Div([
        html.Label("4. Electricity Prices for Household Consumers by Country in 2010 and 2021", 
            ...
            html.Div([              
                            html.P('The prices of electricity changed throughout the years and here you have the opportunity to see these changes and compare prices among countries. Besides that, you can also compare them with the EU average. Try it out!')
                        ], className='box_comment',style={'width':'50%'})
    ...
    html.Div([
        html.Label("5. Electricity Consumption by Sector", style={'font-size': 'medium'}),
            ...
            dcc.Graph(id = 'tree_graph', figure = fig_tree),html.Div([              
                            html.P('Every country consumes different amounts of electricity in its sectors. By the electricity consumption we can have a better understanding of the economic structure of the members primary, secondary, and tertiary sectors. Were you aware of the differences?')
                        ], className='box_comment',style={'width':'50%'})
        ...
        dbc.Col([
            html.Div([
                ...
                dcc.Graph(id = 'share_zero', figure = fig_race),html.Div([              
                            html.P('This plot provides us information about the newly registered electric vehicles in EU countries since 2011. From the goals of the Green Deal programm, we can see who is first in the race for the energetic transition of the automotive sector over the years. Click play or use the cursor to see who is first!')
                        ], className='box_comment',style={'width':'50%'})
            ], className='box', style={'padding-bottom':'15px'})            
        ],width=8),
